import { promoteIntent } from './promote-intent';
import { collaborationCommand, refreshCollaboration } from './intent-preparation';
...
export function reduceMeeting(
  ...
  switch (command.type) {
    case 'collaborationPromote':
      result = promoteIntent(m, p, command.id);
      break;
