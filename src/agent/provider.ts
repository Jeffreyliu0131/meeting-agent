    ...
    (schemaValue as unknown) === Proposal
      ? Proposal.extend({
          objects: z
            ...
            .max(60),
          collaboration: Proposal.shape.collaboration.unwrap(),
